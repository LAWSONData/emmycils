...
export const formations: Formation[] = [
  ...
  // },
  {
    ...
    title: 'Formation Technique Niveau 2',
    ...
    includes: {
      pdfs: [],
      videos: [
        { name: 'Introduction Générale', filename: 'intro-generale.mp4' },
        { name: 'MODULE 0 – Matériel & espace de travail ELITE', filename: 'module-0-materiel.mp4' },
        { name: '2.1 Introduction', filename: 'module-2-intro.mp4' },
        { name: 'Leçon 1 – Les fondamentaux de la pose', filename: 'lecon-01-fondamentaux.mp4' },
        { name: 'Leçon 2 – Les contre-indications', filename: 'lecon-02-contre-indications.mp4' },
        { name: 'Leçon 3 – Cycle de croissance & rétention', filename: 'lecon-03-cycle-croissance.mp4' },
        { name: 'Leçon 4 – Éviter les réactions allergiques', filename: 'lecon-04-allergies.mp4' },
        { name: 'Leçon 5 – Produits de préparation', filename: 'lecon-05-preparation.mp4' },
        { name: 'Leçon 6 – Maîtrise de la colle', filename: 'lecon-06-colle.mp4' },
        { name: 'Leçon 7 – Choisir ses extensions', filename: 'lecon-07-choix-extensions.mp4' },
        { name: 'Leçon 8 – Pose harmonieuse', filename: 'lecon-08-pose-harmonieuse.mp4' },
        { name: 'Leçon 9 – Pose sur mesure', filename: 'lecon-09-pose-sur-mesure.mp4' },
        { name: 'Leçon 10 – Choisir ses effets', filename: 'lecon-10-effets.mp4' },
        { name: 'Leçon 11 – La bonne posture', filename: 'lecon-11-posture.mp4' },
        { name: 'Leçon 12 – Rappel du matériel', filename: 'lecon-12-materiel.mp4' },
        { name: 'Leçon 13 – Préparation de la pose', filename: 'lecon-13-preparation-pose.mp4' },
        { name: 'Leçon 14 – Étude de cas sur modèle', filename: 'lecon-14-etude-cas.mp4' },
        { name: 'Leçon 15 – Ma technique signature', filename: 'lecon-15-technique-signature.mp4' },
        { name: 'Leçon 16 – Coins internes & externes', filename: 'lecon-16-coins.mp4' },
        { name: 'Leçon 17 – Travailler les cils afro', filename: 'lecon-17-cils-afro.mp4' },
        { name: 'Leçon 18 – Dépose propre & sécurisée', filename: 'lecon-18-depose.mp4' },
